...
from App.forms import RegistrationForm, LoginForm, UpdateAcoountForm, PostForm, ResetRequestForm, ResetPasswordForm
...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash(f'your account successfully created. Please login!', "success")
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bc.check_password_hash(user.password, form.password.data):
            ...
            flash("login unsucessful. check password and username","danger")
...
def account():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(f'Your account info updated', 'success')
